...
Continuously monitors laptop camera, detects faces, and sends images to Hugging Face API
"""
...
class CameraFaceDetector:
    def __init__(self, huggingface_api_url: str = None, huggingface_api_token: Optional[str] = None, use_gradio_client: bool = True):
        """
